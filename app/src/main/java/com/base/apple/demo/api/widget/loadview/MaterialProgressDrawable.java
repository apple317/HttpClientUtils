...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
         ...
         *
         * @param width  Width of the hypotenuse of the arrow icon_default_avatar_gray
        ...
        /**
         * @param show Set to true to show the arrow icon_default_avatar_gray on the progress spinner.
         */
