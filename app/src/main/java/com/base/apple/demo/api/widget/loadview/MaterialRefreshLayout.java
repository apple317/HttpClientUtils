...
public class MaterialRefreshLayout extends RelativeLayout {

    public static final String Tag = MaterialRefreshLayout.class.getSimpleName();
//    private final static int DEFAULT_WAVE_HEIGHT = 140;
    private final static int HIGHER_WAVE_HEIGHT = 100;
//    private final static int DEFAULT_HEAD_HEIGHT = 80;
    private final static int HIGHER_HEAD_HEIGHT = 80;
...
//        }
    ...
    protected void onAttachedToWindow() {
        ...
        if (isSunStyle) {
            ...
            LayoutParams layoutParams = new LayoutParams(SystemUtils.getPhoneWidth(context), SystemUtils.dip2px(context, HIGHER_HEAD_HEIGHT));
